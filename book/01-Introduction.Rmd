...
install.packages(c("ROCR", "pracma", "ggplot2", "glmnet", "igraph", "reshape2", "bigmemory", "doParallel", "foreach", "combinat", "rappdirs", "RColorBrewer", "Rtsne", "rmarkdown"))

# install BioConductor dependencies
BiocManager::install(c("RCy3", "biomaRt", "MultiAssayExperiment", "curatedTCGAData", "TCGAutils", "BiocFileCache", "GenomicRanges", "GenomeInfoDb", "IRanges", "scater", "clusterExperiment", "netSmooth",  "BiocStyle","Rtsne"))
