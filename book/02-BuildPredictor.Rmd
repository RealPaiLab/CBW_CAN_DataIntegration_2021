# Module 10 Lab 1: Three-way classifier from four genomic layers
...
```{r, class.source="codeblock",echo=TRUE, fig.cap="Lab 1 design: We will integrate four layers of genomic data. Each layer will be converted into a single patient similarity network using Pearson correlation for pairwise similarity. ",echo=FALSE}
...
```{r lab1-buildpredictor ,class.source="codeblock",eval=FALSE}
...
```{r lab1-getresults,class.source="codeblock",eval=FALSE}
source("helper.R")
...
```{r, class.source="codeblock",fig.width=8,fig.height=8, eval=FALSE}
