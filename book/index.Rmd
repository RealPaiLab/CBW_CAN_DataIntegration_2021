...
* **Luminal A** tumours are the most common subtype (50-60% of all breast tumours), with low histological grade; good prognosis; ER+; HER2-.
* **Luminal B** tumours are less common (15-20%), with worse prognosis than Luminal A; ER+;  HER2 status variable.
* **Basal-like** tumours are also less common (8-37%), with distinctive histological features (infiltrative ductal tumours), poor prognosis, ER-; HER2-
