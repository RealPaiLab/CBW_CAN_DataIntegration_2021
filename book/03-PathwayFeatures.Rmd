...
download.file("https://github.com/RealPaiLab/CBW_CAN_DataIntegration_2021/raw/master/supporting_files/gmt_pathway_2021/brca_pathways_full.rda",
	destfile=outFile)
lnames <- load(outFile)
```
...
You should be able to [download the Cytoscape session file here](https://github.com/RealPaiLab/CBW_CAN_DataIntegration_2021/raw/master/supporting_files/gmt_pathway_2021/LuminalA.cys) to see the finished result.
