...
```{r, class.source="codeblock",echo=FALSE, fig.cap="Lab 2: Predictor design", echo=FALSE}
...
```{r, class.source="codeblock", class.source="codeblock",eval=FALSE}
...
```{r, class.source="codeblock",echo=FALSE, fig.cap="Lab 2: Predictor design"}
...
```{r lab2-buildpredictor,class.source="codeblock",eval=FALSE}
t0 <- Sys.time()
...
You can also [download the Cytoscape session file here](https://github.com/RealPaiLab/CBW_CAN_DataIntegration_2021/raw/master/supporting_files/Lab2_files/LuminalA.cys) to see the finished result. 
